...
-- map("n", "<leader>tot",  function() require("neotest").output.open({enter = true}) end, {desc = "Toggle Neotest Output for a test"})


-- map("n", "<A-S>", ":Neotest summary<CR>", {desc = "Toggle Neotest Summary"})
